...
public class LogInfoTest {
  ...
  public static final byte[] LOG_ID = Base64.decode("pLkJkLQYWBSHuxOizGdwCjw1mAT5G9+443fNDsgN3BA=");

  /** RSA log key */
  public static final byte[] PUBLIC_KEY_RSA =
      Base64.decode(
  ...
  public static final byte[] LOG_ID_RSA =
      Base64.decode("oCQsumIkVhezsKvGJ+spTJIM9H+jy/OdvSGDIX0VsgY=");
